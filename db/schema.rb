...
ActiveRecord::Schema.define(version: 20190220083145) do

  create_table "add_like_count_to_products", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
